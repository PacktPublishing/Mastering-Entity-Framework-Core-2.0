...
namespace MasteringEFCore.Transactions.Final.Data
{
                ...
                try
                {
                    ...
                    var posts = new[]
                    {
                        new Post
                        {
                            ...
                            Url = "Dotnet 4.7 Released".Generate(),
                            AuthorId = 1,
                            CategoryId = 1,
                            CreatedAt = DateTime.Now,
                            CreatedBy = 1
                        ...
                        new Post
                        {
                            Title = "Dotnet Core 1.1 Released",
                            BlogId = 2,
                            Content = "Dotnet Core 1.1 Released Contents",
                            PublishedDateTime = DateTime.Now,
                            Url = "Dotnet Core 1.1 Released Contents".Generate(),
                            AuthorId = 1,
                            CategoryId = 2,
                            CreatedAt = DateTime.Now,
                            CreatedBy = 1
                        ...
                        new Post
                        {
                            ...
                            PublishedDateTime = DateTime.Now,
                            Url = "EF Core 1.1 Released Contents".Generate(),
                            AuthorId = 1,
                            CategoryId = 2,
                            CreatedAt = DateTime.Now,
                            CreatedBy = 1
