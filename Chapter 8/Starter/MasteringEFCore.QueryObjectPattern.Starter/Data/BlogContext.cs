...
using MasteringEFCore.QueryObjectPattern.Starter.Models;
using Microsoft.EntityFrameworkCore;
using MasteringEFCore.QueryObjectPattern.Starter.ViewModels;

namespace MasteringEFCore.QueryObjectPattern.Starter.Data
{
    public class BlogContext: DbContext
    {
        ...
        public DbSet<MasteringEFCore.QueryObjectPattern.Starter.ViewModels.RegistrationViewModel> RegistrationViewModel { get; set; }
    }
}
